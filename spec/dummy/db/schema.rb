...
ActiveRecord::Schema[8.0].define(version: 2025_02_20_224852) do
  ...
  create_table "blogging_posts_tags", id: false, force: :cascade do |t|
    t.bigint "blogging_post_id", null: false
    t.bigint "blogging_tag_id", null: false
